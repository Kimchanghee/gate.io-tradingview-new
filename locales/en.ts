...
export const en = {
  ...
  autoTradeSettingsDescription: "Configure the default investment amount and leverage used when a signal triggers auto trading.",
  autoTradeRequiresConnection: "Connect your API keys to enable auto trading.",
  autoTradeMonitoring: "Auto trading is monitoring incoming signals.",
  autoTradeDisabledHint: "Enable auto trading from the API settings card to execute signals automatically.",
  autoTradeInsufficientFunds: "Investment amount exceeds the available USDT balance. Adjust the amount or transfer more funds.",
  autoTradeInvalidLeverage: "Requested leverage exceeds the allowed limit.",
  autoTradeAmountRequired: "Set an investment amount of at least 1 USDT to run auto trading.",
  autoTradeExecutionFailed: "Failed to execute auto trade.",
  autoTradeExecuted: "Auto trade executed.",
  autoTradeSymbolMismatch: "Signal symbol does not match the current settings, skipping auto trade.",
  on: "ON",
  off: "OFF",
